...
# Usage:
#   bash policy/DP/eval.sh <task_name> <task_config> <ckpt_setting> <expert_data_num> <seed> <gpu_id> [checkpoint_num] [ckpt_path]
...
log_file="${log_dir}/eval_DP_${task_name}_ckpt${ckpt_setting}_N${expert_data_num}_seed${seed}_ckptnum${checkpoint_num}.log"
