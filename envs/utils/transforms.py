...
def rotate_along_axis(
    ...
    """
     center  towards  center->target  towards 

    target_pose: 
    center_pose: 
    axis: 
    theta: 
    axis_type: 'center' center_pose'target' target_pose'world' 'center'
    towards: 
    camera_face:  None
    34
    """
...
def get_place_pose(
    ...
    constrain: 
        - free: 
        - align:  x 
    align_axis:  None target_pose  x 
    actor_axis:  actor  x 
    actor_axis_type: actor_axis 
        - actor: actor_pose 
        - world: 
    """
